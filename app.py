...
def update_options_chart(ticker, dates, selected_params):
    ...
    if ticker in ["^SPX", "^NDX", "^RUT", "^Dia"]:
        price_range = 0.0135  # 1.5% для индексов
